...
if __name__ == "__main__":
    ...
    model, processor = setup_captioning_model(model_id="google/gemma-3-12b-it", gpu_ids="0,1,2")
    
    # Example image URL
    # image_url = "https://example.com/your-image.jpg"
    image_path = "/media/otter/cloth1m/v3/cloth1m_data_v3/images/Dress/Green_Linen_Plaid/000083.jpg"
